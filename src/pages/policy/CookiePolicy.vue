<template>
  <div class="container">
    <PageHeading :display="4">Cookie policy</PageHeading>

    <TextHeading class="mt-5">What are cookies?</TextHeading>
    <TextParagraph>
    ...
    <TextHeading class="mt-5">What type of cookies we use?</TextHeading>
    <TextParagraph>
    ...
    <TextHeading class="mt-5">What do we use cookies for?</TextHeading>
    <TextParagraph>
    ...
    <TextHeading class="mt-5">How can I control or delete cookies?</TextHeading>
    <TextParagraph>
      Within your browser you can choose whether you wish to accept cookies or not. To find out more on how to manage and delete cookies, visit aboutcookies.org. Please remember, if you do delete some or all your cookies, some features on our website, such as remembering your username, may not work and your experience on our website may be affected.
    </TextParagraph>

    <TextHeading class="mt-5">More information about cookies</TextHeading>
    <TextParagraph class="mb-5">
      <ul>
        <li><strong><Link link="allaboutcookies.org" /></strong></li>
        <li><strong><Link link="cookiepedia.co.uk" /></strong></li>
      </ul>
    </TextParagraph>
  </div>
</template>
