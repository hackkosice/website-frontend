<template>
  <div class="container">
    ...
    <TextParagraph>
      ...
      Major League Hacking (MLH) is the official student hackathon league. By using the Service, you authorize us to share your application/registration information for event administration, ranking, MLH administration, pre- and post-event informational e-mails, and occasional messages about hackathons in-line with the <Link title="MLH Privacy Policy" link="https://mlh.io/privacy" target="_blank" :external="true" />. You further agree to the terms of both the <Link title="MLH Contest Terms and Conditions" link="https://github.com/MLH/mlh-policies/blob/master/prize-terms-and-conditions/contest-terms.md" target="_blank" :external="true" /> and the <Link title="MLH Privacy Policy" link="https://mlh.io/privacy" target="_blank" :external="true" />.
    </TextParagraph>

    <TextHeading class="mt-5">Accessing, changing and removing your information</TextHeading>
    <TextParagraph>
      It is your legal right to view all information collected about you by us. To access, change or delete information about you, please contact us anytime at <Link title="contact@hackkosice.com" link="mailto:contact@hackkosice.com" :external="true" />.
    </TextParagraph>
    ...
    <TextParagraph>
      ...
      These images will be used to share news about Hack Kosice, and to publicise our future events. Images may be used in press releases, printed publicity and published on our social media. If you would like to see your images or would like us to delete them, please write email to <Link title="contact@hackkosice.com" link="mailto:contact@hackkosice.com" :external="true" />.
    ...
    <TextParagraph>
      By participating at any events organised by Hack Kosice, or events related to Hack Kosice organised by our partners, you agree to follow the <Link title="MLH Code of Conduct" link="https://static.mlh.io/docs/mlh-member-event-guidelines.pdf" :external="true" />. This extends to all attendees, including hackers, volunteers, organizers, sponsors, partners, judges, mentors, and MLH staff.
    </TextParagraph>
    ...
    <TextParagraph>
      ...
      You can opt-out of having your activity on the website made available to Google Analytics by installing the Google Analytics opt-out browser add-on (<Link link="https://tools.google.com/dlpage/gaoptout" :external="true" />) for your web browser.

      For more information visit <Link link="www.google.com/policies/privacy/partners/" :external="true" />.
    </TextParagraph>
    ...
    <TextParagraph>
      ...
      For more information visit our <Link title="Cookie policy" link="/policy/cookie" />.
    </TextParagraph>
